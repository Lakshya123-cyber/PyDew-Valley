...
class Menu:
    ...
    def input(self):
        # get the input
        # if player presses esc, close the Menu
    ...
    def update(self):
        self.input()
        self.display_money()
        for text_i, text_surf in enumerate(self.text_surfs):
            top = self.main_rect.top + text_i * (
            ...
            amount = amount_list[text_i]
            self.show_entry(text_surf, amount, top, self.index == text_i)
